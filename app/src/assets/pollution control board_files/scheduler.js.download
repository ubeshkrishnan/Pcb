...
function Ga(a){var b=v("ytcsi.tick");b&&b(a)}
function Ha(){Ga("jse");Ia()}
function Ia(){window.clearTimeout(X);Z().start()}
function Ja(){var a=Z();U(a);a.C=!0;window.clearTimeout(X);X=window.setTimeout(Ha,za)}
function Ka(){window.clearTimeout(Y);Y=window.setTimeout(function(){Ga("jset");La(0)},za)}
